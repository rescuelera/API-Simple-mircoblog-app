...
from user_data import INVALID_ID, RESPONCE_WITH_INVALID_UID
...
class TestGetMicroblogByMicropostid():
    ...
    def test_get_microblog_with_invalid_micropost_id(self, non_existent_micropost_id):
        api = MicroblogApiSteps()
    ...
    def test_get_microblog_with_invalid_micropost_id(self):
        ...
        json_obj = r.json()
        assert json_obj == RESPONCE_WITH_INVALID_UID